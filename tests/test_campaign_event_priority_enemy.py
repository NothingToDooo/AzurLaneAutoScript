...
class _RecordingCampaign:
    def __init__(self, successful_call=None) -> None:
    ...
    def clear_enemy(self, *, scale, genre=None):
...
def test_d1_priority_enemy_keeps_scale_1_before_genre_filters(campaign_cls) -> None:
...
def test_d3_battle_0_keeps_fleet_protection_and_skips_scale_1(campaign_cls) -> None:
...
@pytest.mark.parametrize("campaign_cls", [_EventD3, _WarArchivesD3])
def test_d3_battle_5_keeps_scale_1_priority(campaign_cls) -> None:
