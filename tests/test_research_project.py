...
def test_research_project_get_data_tries_digit_name_prefixes(monkeypatch) -> None:
...
def test_research_project_get_data_tries_c_when_d_is_not_found(monkeypatch) -> None:
...
def test_research_project_get_data_matches_trimmed_suffix(monkeypatch) -> None:
...
def test_research_project_get_data_has_no_hidden_return_value(monkeypatch) -> None:
    project = _bare_project(series=5)
