...
if server.server in ["cn", "jp", "tw"]:
    ...
    OCR_DAILY_COUNT = DigitCounter(pq_assets.PRIVATE_QUARTERS_DAILY_COUNT, letter=(255, 247, 247))
...
if server.server != "jp":
    ...
    OCR_SHOP_GOLD_COINS = Digit(
        pq_assets.PRIVATE_QUARTERS_SHOP_GOLD_COINS, letter=(201, 201, 201), name="OCR_SHOP_GOLD_COINS"
    )

if server.server != "jp":
    OCR_SHOP_GEMS = Digit(pq_assets.PRIVATE_QUARTERS_SHOP_GEMS, letter=(255, 243, 82), name="OCR_SHOP_GEMS")
else:
    OCR_SHOP_GEMS = Digit(pq_assets.PRIVATE_QUARTERS_SHOP_GEMS, letter=(190, 180, 82), name="OCR_SHOP_GEMS")
