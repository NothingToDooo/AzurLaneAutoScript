...
class FleetEquipment(EquipmentChange):
    def fleet_enter(self, fleet: int) -> None:
        ...
        for _ in self.loop():
            current = letter.ocr_single(self.device.image)
    ...
    def fleet_equipment_take_on_preset(
        ...
        enter: Button = equipment_assets.FLEET_DETAIL_ENTER_FLAGSHIP,
        *,
        long_click: bool = False,
        out: Button = equipment_assets.FLEET_DETAIL_CHECK,
    ) -> None:
        self.ui_click(
    ...
    def fleet_enter_ship(self, button: Button) -> None:
        self.ui_click(
            equipment_assets.FLEET_DETAIL,
            appear_button=page_fleet.check_button,
            check_button=equipment_assets.FLEET_DETAIL_CHECK,
