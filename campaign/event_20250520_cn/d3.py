...
class Campaign(CampaignBase):
    ...
    def battle_function(self):
        ...
        if self.config.MAP_CLEAR_ALL_THIS_TIME:
            ...
            if remain and (self.fleet_2_protect() or self.clear_any_enemy(sort=("weight", "cost_2", "cost_1"))):
                return True
        if not self.map_is_clear_mode:
            ...
            if not boss and (self.fleet_2_protect() or self.clear_any_enemy(sort=("weight", "cost_2", "cost_1"))):
                return True
